...
//    MethodDef(name, typeVars, params::Nil, evidence, Some(returnType), body, comment)
//
...
//  def mkEndInstance(ctx: RoleCtx):Statement =
//    if ctx.forkes then
...
//    MethodDef(name, typeVars, params, evidence, Some(returnType), body, comment)
//
